...
import { Sparkles, ShieldCheck, Check, ArrowRight, Loader2 } from "lucide-react";
...
export default function LeadQualificationSheet({ isOpen, onClose, project, unitConfig }: LeadQualificationSheetProps) {
  ...
  const isStepAValid = formData.name.length >= 2 && /^\d{10}$/.test(formData.phone) && formData.timeline !== '';
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        { id: 'urgent', label: '🔥 Within 3mo' },
                        { id: 'medium', label: '📅 3–6mo' },
                        { id: 'long', label: '🕐 6–12mo' },
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[var(--border)]/30 rounded-xl p-4 space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-[var(--text-primary)] font-medium">{formData.date || 'TBD'}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-[var(--text-muted)]">Time Slot</span>
                        <span className="text-[var(--text-primary)] font-medium">{formData.time || 'TBD'}</span>
                      </div>
                      <div className="flex justify-between text-sm">
