    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex items-center gap-3 py-8 border-b border-[var(--border)]">
          ...
          <button
            onClick={() => navigator.share?.({ title: blog.title, url: typeof window !== 'undefined' ? window.location.href : '' }) || navigator.clipboard?.writeText(typeof window !== 'undefined' ? window.location.href : '')}
