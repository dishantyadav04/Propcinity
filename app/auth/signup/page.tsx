  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (next !== '/onboarding') {
          document.cookie = `signup_next=${encodeURIComponent(next)}; path=/auth/confirm; max-age=3600; SameSite=Lax`
        }
      }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-[var(--text-muted)] font-semibold">or sign up with email</span>
          <div className="flex-1 h-px bg-[var(--border)]" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="10-digit mobile" type="tel" required pattern="[0-9]{10}"
