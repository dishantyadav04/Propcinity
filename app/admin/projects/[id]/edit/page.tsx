    ...
    const loadProject = async () => {
      try {
        ...
        const mapped: Project = {
          ...
          totalUnits: raw.total_units ?? undefined,
          availableUnits: raw.available_units ?? undefined,
          unitConfigs: (raw.unit_configs || []).map((u: any) => ({
            ...
            maintenancePerMonth: u.maintenance_cost ?? undefined,
            parking: u.parking,
            total: u.total ?? undefined,
